      ...
      <div className='footer__content'>
        <div className='footer__content-data' data-aos="fade-up">
          ...
          <div className='footer_contact'>
            ...
            <p><img src={telefono} alt="telefono" />+54 9 2246558042</p>
        ...
        <div className='form__container'>
          <form action="https://formspree.io/f/xjvnlkbl" method="post" data-aos="fade-up">
            ...
            <h4><span>¿BUSCAS RESULTADOS REALES?</span><br />Te ayudamos a alcanzar tus metas.</h4>
            <div className='form__inputs'>
              <div className='footer__input_name'>
                <label htmlFor="name">Nombre</label>
                <input
                  placeholder='Escribi tu nombre o el de tu negocio'
                  type="text"
                  id="name"
                  name="name"
                  value={formData.name}
              ...
              <div className='footer__input_email'>
                ...
                <input
                  placeholder='Escribi un email valido'
                  type="email"
                  id="email"
                  name="email"
